...
This script reads the directory of binary files produced by I<read_table.pl> and
returns the contents of F<SESSION/match.meta> in JSON format.

Meant to be called from the web interface.
