...
@app.route('/search/<target>/<source>/<unit>/<form>')
def read_bin(target, source, form, unit):
    ...
    cmd = " ".join(["perl", "/var/www/tesserae/cgi-bin/read_bin_tmv.pl", "--path", path, "--export", form, "--window", "5"])
