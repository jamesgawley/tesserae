...
<p>tess2bow.pl - Print a Tesserae text as a simple bag of words.</p>

<h1 id="SYNOPSIS">SYNOPSIS</h1>

<p>tess2bow.pl [options] NAME</p>

<h1 id="DESCRIPTION">DESCRIPTION</h1>

<p>Prints out a Tesserae text in a simplified format. Useful if you want to process texts on your own and want to be sure you have the same &quot;words&quot; or other features as Tesserae uses.</p>

<h1 id="OPTIONS-AND-ARGUMENTS">OPTIONS AND ARGUMENTS</h1>

<dl>

<dt id="NAME1"><i>NAME</i></dt>
<dd>

<p>The text to process.</p>

</dd>
<dt id="feature-FEAT"><b>--feature</b> FEAT</dt>
<dd>

<p>Each word token in the text will be translated into its FEAT feature(s). In the case where a token is indexed under multiple features, these will be separated by commas (but no spaces).</p>
...
<p>The Original Code is tess2bow.pl.</p>
