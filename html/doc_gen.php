...
<p>doc_gen.pl - Generate the HTML formatted documentation for Tesserae.</p>

<h1 id="SYNOPSIS">SYNOPSIS</h1>

<p>doc_gen.pl [options]</p>

<h1 id="DESCRIPTION">DESCRIPTION</h1>

<p>This script should be run after configure.pl. It seeks out the /scripts folder and one layer of subdirectories looking for PERL scripts with POD documentation in their headers. Then it creates a folder inside tesserae/doc/ where it stores HTML versions of these descriptions.</p>
...
<p>The Original Code is doc_gen.pl.</p>
...
<p>Contributor(s): James Gawley</p>
