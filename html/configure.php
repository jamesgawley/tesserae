...
<p>configure.pl - create tesserae.conf</p>

<h1 id="SYNOPSIS">SYNOPSIS</h1>

<p>configure.pl [options]</p>

<h1 id="DESCRIPTION">DESCRIPTION</h1>

<p>This script allows the user to interactively set configuration options for Tesserae, in particular, paths to different elements of the local installation. It then creates <i>tesserae.conf</i> in the <i>scripts/</i> directory, as well as pointers to the configuration file in <i>scripts/</i> and <i>cgi-bin/</i>.</p>
...
<p>Don&#39;t run interactively, just assume that everything is installed as it is in the Git repository.</p>
